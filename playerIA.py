...
count = 1
# Définition de la priorité de jeu pour le joueur ou l'intelligence artificielle, définie de manière aléatoire afin de déterminer le premier joueur.
...
while not board.is_game_over():
    ...
    # Entrez dans le mode de jeu Joueur/IA.
        ...
        if joueurIA == 1 :
            ...
            # Boucle permettant la répétition de la demande du coup du joueur temps que celui-ci est considéré comme invalide.
            while coupInvalide == False:
